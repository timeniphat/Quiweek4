...
import com.example.quiweek4.R;
import com.example.quiweek4.WordListActivity;
...
public class GameActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void newQuiz() {
        ...
        mButtons[random].setText(item.word);
        ...
        for (int i = 0; i < 4; i++) {
            if (i == random) { // ถ้า i คือ index ของปุ่มคำตอบ ให้ข้ามไป
                continue;
            }
    ...
    public void onClick(View view) {
        ...
        if (buttonText.equals(mAnswerWord)) {
            Toast.makeText(GameActivity.this, "ถูกครับ", Toast.LENGTH_SHORT).show();
            mScore++;
        } else {
